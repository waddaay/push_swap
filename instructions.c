...
/*   Updated: 2022/07/16 00:43:21 by ywadday          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void push_rb(t_stack *stack_a, t_stack *stack_b, int *s_tab, t_attr attr)
{
    ...
    stack_b->top <= stack_b->size - 2 && stack_b->body[stack_b->top] >= attr.vp1)
    {
        rotate(stack_b, "rb\n", attr.b);
        stack_a->count++;
    }
...
void instructions(t_stack *stack_a, t_stack *stack_b, int *s_tab, t_attr attr)
{
